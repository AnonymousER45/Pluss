...
urlpatterns = [
    ...
    path("category3b/<int:myid>",views.Category3b,name="Category3b"),
    path("category3c/<int:myid>",views.Category3c,name="Category3c"),
    path("category4/<int:myid>",views.Category4,name="Category4"),
    path("category4b/<int:myid>",views.Category4b,name="Category4b"),
    ...
    path("showall/<int:idshowall>",views.showall,name="showall"),
    path("comboshowall/<int:idshowall>",views.comboshowall,name="comboshowall"),
    ...
    path("online_payment/<int:order_id>",views.start_onlinepayments,name="start_onlinepayments"),
    path("online_payments/<int:order_id>",views.start_onlinepayments2,name="start_onlinepayments2"),
