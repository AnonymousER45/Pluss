...
urlpatterns = [
    ...
    path("category10/<int:myid>",views.Category10,name="Category10"),
    path("schoolzonelistview",views.schoolzonelistview,name="schoolzonelistview"),
    path("productdetails/<int:id>",views.Productdetails,name="Productdetails"),
    path("showall",views.showall,name="showall"),
    path("comboshowall",views.comboshowall,name="comboshowall"),
    ...
    #path("emptywish",views.emptywish,name="emptywish"),
